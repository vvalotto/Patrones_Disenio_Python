...
class VisualizadorCondicionesActuales(Observado, Visualizador):
    '''
...
class VisualizadorPronostico(Observado, Visualizador):
...
class VisualizadorEstadisticas(Observado, Visualizador):
...
class VisualizadorIndiceCalor(Observado, Visualizador):
